...
class JobItemDetails extends Component {
  ...
  getFetchedSimilarJobsData = data => ({
  ...
  getJob = async () => {
    ...
    if (response.ok === true) {
      ...
      const updatedData = this.getFetchedData(data.job_details)
      const updatedSimilarJobsData = data.similar_jobs.map(eachJob =>
        this.getFetchedSimilarJobsData(eachJob),
      )
        ...
        <div className="job-item">
          ...
          <ul className="skills-list-container">
            {skills.map(eachSkill => (
              <SkillCard key={eachSkill.name} skill={eachSkill} />
            ))}
          </ul>
